...
export namespace MeansOfDeath {
    export function toString(meansOfDeath: MeansOfDeath): string {
        return MeansOfDeath[meansOfDeath];
    }

    export function parse(meansOfDeath: string): MeansOfDeath {
        return MeansOfDeath[meansOfDeath];
    }
}